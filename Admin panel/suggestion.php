			...
			if($img_sizes <= $max){
				if (!file_exists($tmp_location.$post_image)) {
					...
					if ($successful) {
						...
						header("location:dashboard.php?msg2=".$msg."");
						exit();
					}
...
<body>
	<nav class="navbar">
		<div class="container-fluid">
			...
			<div id="navbar" class="collapse navbar-collapse">
				...
				<?php }?>
					<li class="active"><a href="Suggestion.php">Feedback</a></li>
				</ul>
	...
	<header id="header">
		<div class="container">
			<div class="row">
				<div class="col-md-10">
					<h1><span class="fa fa-gear fa-lg"> DashBoard</span> <small>Akprokp Blog</small></h1>
				</div>
				<div class="col-md-2">
	...
	<script type="text/javascript" src="../assets/bootstrap/js/msg.js"></script>
