...
$count_posts = "SELECT COUNT(post_id) as total_post FROM posts";
	...
	$total_post = "UPDATE total_all SET total_comment='$total_comment', total_post='$total_post', total_user='$total_users' WHERE total_id=1";
...
if (isset($_POST['submit'])) {
	...
	$img_sizes = $_FILES['post_img']['size'];
...
<body>
	...
	<header id="header">
		<div class="container">
			<div class="row">
				<div class="col-md-10">
					<h1><span class="fa fa-cogs fa-lg"> DashBoard</span> <small>Akprokp Blog</small></h1>
				</div>
				<div class="col-md-2">
					...
					<div class="panel panel">
						...
						<div class="panel-body">
							...
							<div class="col-md-3 text-center">
								<div class="bg-info"  style="padding:20px; border-radius: 5px;">
									<h2><span class="fa fa-user fa-lg"></span><?php echo $total_user; ?></h2>
									<h4>Users</h4>
								</div>
							</div>
							<div class="col-md-3 text-center">
								<div class="bg-warning"  style="padding:20px; border-radius: 5px;">
									<h2><span class="fa fa-comments fa-lg"></span> <?php echo $total_comment; ?></h2>
									<h4>Comments</h4>
								</div>
							</div>
							<div class="col-md-3 text-center">
								<div class="bg-success"  style="padding:20px; border-radius: 5px;">
									<h2><span class="fa fa-pencil fa-lg"></span><?php echo $total_post; ?></h2>
									<h4>Posts</h4>
								</div>
							</div>
							<div class="col-md-3 text-center">
								<div class="bg-danger"  style="padding:20px; border-radius: 5px;">
									<h2><span class="fa fa-sign-in fa-lg"></span> 5,000 </h2>
									<h4>Visitors</h4>
								</div>
							</div>
							<?php } else{?>
							<div class="col-md-3 text-center">
								<div style="background-color: #97E8AC; padding:20px; border-radius: 5px;">
									<h2><span class="fa fa-comments fa-lg"></span> <?php echo $total_comment; ?></h2>
									<h4>Comments</h4>
								</div>
							</div>
							...
							<div class="col-md-3 text-center">
								<div class="bg-primary"  style="padding:20px; border-radius: 5px;">
									<h2><span class="fa fa-sign-in fa-lg"></span> 5,000 </h2>
									<h4>Visitors</h4>
								</div>
							</div>
	      	...
	      	<h3 class="text text-danger" id="err"></h3>
	       	<form method="POST" enctype="multipart/form-data">
	        	...
	        	<div class="form-group">
							...
							<select class="form-control"  name="heading" id="post_heading" onchange="mark_text(this)" required="">
	...
	<script type="text/javascript" src="../assets/bootstrap/js/dash.js"></script>
