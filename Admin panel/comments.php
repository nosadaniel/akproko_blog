...
<body>
	...
	<header id="header">
		<div class="container">
			<div class="row">
				<div class="col-md-10">
					<h1><span class="fa fa-gear fa-lg"> Pages</span> <small>Manage Site Pages</small></h1>
				</div>
				<div class="col-md-2">
				...
				<div class="col-md-9">
					<div class='panel panel'>
						...
						<div class='panel-body'>
							<div class='row'>
								<div class='col-md-12'>
									<input type='text' name='filter_comment' id='filter_comment' class='form-control' placeholder='filter by name or content...'>
								</div>
							</div>
							<br>
